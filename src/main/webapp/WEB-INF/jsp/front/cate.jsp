...
<div class="container">
  <h1 class="t_nav"><span>${checkNumList[0].blogger.introduction}</span><a href="/" class="n1">网站首页</a><a href="${pageContext.request.contextPath}/articles/1" class="n2">轻博客</a></h1>
  <!--blogsbox begin-->
  <div class="blogsbox" id="blogs">
  </div>
  <jsp:include page="common/aside.jsp"/>
  <div id="page" style="width: 100%; margin: 0 auto;"></div>
  <!--blogsbox end-->
</div>
...
<script src="${pageContext.request.contextPath}/static/js/cate.js"></script>
</body>
</html>
